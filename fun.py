...
tdm_gp = ut.InfRet(tdm, gproofs)
fv_rec, fv_pre = tdm_gp.fullv(11)
# plot
...
# lsi
lsi_70_rec, lsi_70_prec, lsi_70_apprx_error = tdm_gp.lsi(36, 70)
lsi_100_rec, lsi_100_prec, lsi_100_apprx_error = tdm_gp.lsi(11, 100)
lsi_opt_rec, lsi_opt_prec, lsi_opt_apprx_error = tdm_gp.lsi(11)
...
####### 3.5. Clustering
cls_50_rec, cls_50_prec, cls_50_apprx_error = tdm_gp.cluster(11, 50)
cls_100_rec, cls_100_prec, cls_100_apprx_error = tdm_gp.cluster(11, 100)
...
nmf_50_rec, nmf_50_prec, nmf_50_apprx_error = tdm_gp.nmf(11, 50)
nmf_10_rec, nmf_10_prec, nmf_10_apprx_error = tdm_gp.nmf(11, 10)
...
lgkb_4_rec, lgkb_4_prec, lgkb_4_apprx_error = tdm_gp.lgkb(11, 4)
lgkb_2_rec, lgkb_2_prec, lgkb_2_apprx_error = tdm_gp.lgkb(11,2)
...
tdm_gp = ut.AvgPrfm(tdm, gproofs)
fullv_recall_points, fullv_precision_values  = tdm_gp.ave_fullv(5)
lsi_opt_recall_points, lsi_opt_precision_values  = tdm_gp.ave_lsi(76,'opt')
cls50_recall_points, cls50_precision_values  = tdm_gp.ave_cluster(76,50)
nmf50_recall_points, nmf50_precision_values  = tdm_gp.ave_nmf(76,50)
lgkb4_recall_points, lgkb4_precision_values  = tdm_gp.ave_lgkb(76,4)
